            ...
            columns: [
                ...
                { data: 'description', name: 'description', defaultContent: '-' },
                {
                    ...
                    render: function (data) {
                        ...
                        const menuItems = [];
                        if (canItemUpdate) menuItems.push(`<div class="menu-item px-3"><a href="${editUrl}" class="menu-link px-3">Edit</a></div>`);
                        if (canItemDelete) menuItems.push(`<div class="menu-item px-3"><a href="#" data-id="${data}" data-url="${delUrl}" class="menu-link px-3 text-danger btn-delete">Hapus</a></div>`);
            ...
            columns: [
                ...
                { data: 'slug', name: 'slug' },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        const menuItems = [];
                        if (canCatUpdate) menuItems.push(`<div class="menu-item px-3"><a href="#" data-id="${data}" data-name="${row.name || ''}" class="menu-link px-3 btn-edit-cat">Edit</a></div>`);
                        if (canCatDelete) menuItems.push(`<div class="menu-item px-3"><a href="#" data-id="${data}" data-url="${delUrl}" class="menu-link px-3 text-danger btn-delete-cat">Hapus</a></div>`);
                        return renderActionsDropdown(menuItems);
                    }
                }
            ]
