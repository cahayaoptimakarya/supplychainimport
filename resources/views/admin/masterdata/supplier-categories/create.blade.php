            ...
            <div class="card-body py-6">
                <form method="POST" action="{{ route('admin.masterdata.supplier-categories.store') }}" class="form">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror form-control-solid" placeholder="Nama kategori supplier" required />
