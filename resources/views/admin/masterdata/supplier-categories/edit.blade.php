...
@section('title', 'Edit Kategori Supplier')

@section('page_title', 'Edit Kategori Supplier')
        ...
        <div class="card">
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <h1 class="fw-bold fs-3">Edit Kategori Supplier</h1>
                </div>
            </div>
            <div class="card-body py-6">
                <form method="POST" action="{{ route('admin.masterdata.supplier-categories.update', $category->id) }}" class="form">
                    @csrf
                    @method('PUT')
